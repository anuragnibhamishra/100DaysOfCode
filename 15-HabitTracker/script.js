...
function renderHabit() {
    ...
    for (let i = 0; i < habits.length; i++) {
        ...
        category.className = "w-12 h-12 mr-4 bg-green-600 rounded-2xl inline-flex items-center justify-center"
        ...
        moreModal.className = "w-fit p-4 bg-neutral-100/4 border-2 backdrop-blur-md hidden border-neutral-200/4 h-fit flex-col absolute rounded-3xl gap-2 right-6 bottom-12 z-10"
        let editBtn = document.createElement("button")
        editBtn.className = "px-6 py-2 border-2 border-blue-700 rounded-xl flex items-center justify-center"
        ...
        habitDiv.appendChild(category)
        infoDiv.appendChild(h1)
        infoDiv.appendChild(p)
        habitDiv.appendChild(infoDiv)
        habitDiv.appendChild(state)
